...
int32_t* gRedLut = nullptr;
int32_t* gBlueLut = nullptr;
int32_t* gUGreenLut = nullptr;
int32_t* gVGreenLut = nullptr;
uint8_t* gClampLut5 = nullptr;
uint8_t* gClampLut6 = nullptr;
