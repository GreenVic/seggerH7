...
// All of these are specified by the JPEG standard, so don't change them * if you want to be compatible. */
...
// On 80x86 machines, the image arrays are too big for near pointers but the pointer arrays can fit in near memory.
...
// The JPP macro hides prototype parameters from compilers that can't cope  Note JPP requires double parentheses.
...
EXTERN(void) jpeg_add_quant_table JPP((j_compress_ptr cinfo, int which_tbl, const unsigned int *basic_table,
